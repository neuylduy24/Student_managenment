                  ...
                  <div class="col-sm-12 col-md-6">
                      <div class="form-group my-3">
                        <input id="keywordCourse" type="text" name="search" value="<?= htmlentities($keyword)?>">
                          <button id="btnSearchCourse" type="button" class="btn btn-primary btn-sm mb-0">
                            Search
                          </button>
                    ...
                    <?php if($state === 'delete_success'): ?>
                      <div class="my-3 text-success">Delete Course Successfully !</div>
                    <?php elseif($state === 'delete_failure'): ?>
                      <div class="my-3 text-danger">Delete Course Failure !</div>
                    <?php endif; ?>
